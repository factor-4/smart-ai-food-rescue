      ...
      <section>
        <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <input
            ...
            className="w-full sm:w-72 rounded-lg border border-slate-300 px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-500"
          />
        </div>
...
function BagCard({ bag }: { bag: BagResponse }) {
